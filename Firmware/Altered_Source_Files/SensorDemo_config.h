...
#ifdef SENSOR_EMULATION
/* Number of attributes requests from the sensor  demo */
#define NUM_APP_GATT_ATTRIBUTES 42//(34) /* 15 attributes x BLE Sensor demo services characteristics */
#else  // No Humidity char
...
#ifdef SENSOR_EMULATION
#define ATT_VALUE_ARRAY_SIZE    (450 + OTA_ATT_VALUE_ARRAY_SIZE)//(43 + 106 + 28 + OTA_ATT_VALUE_ARRAY_SIZE) //(GATT + GAP) = 43 (Device Name: BlueNRG) + Acceleration (Acceleration (27) + Free Fall (21) characteristics) +  Environmental Sensor (Temperature (28) , Pressure (29), Humidity (28) characteristics)  Services
#else
